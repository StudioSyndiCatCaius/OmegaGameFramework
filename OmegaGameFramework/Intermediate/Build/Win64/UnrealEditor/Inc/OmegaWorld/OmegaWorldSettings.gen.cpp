...
template<> OMEGAWORLD_API UScriptStruct* StaticStruct<FOmegaZoneData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOmegaWorldSettings, AOmegaWorldSettings::StaticClass, TEXT("AOmegaWorldSettings"), &Z_Registration_Info_UClass_AOmegaWorldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOmegaWorldSettings), 3425821386U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_3402749728(TEXT("/Script/OmegaWorld"),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaWorld_Public_OmegaWorldSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
