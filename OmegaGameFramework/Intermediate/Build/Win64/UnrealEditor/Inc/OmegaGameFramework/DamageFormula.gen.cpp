...
// End Cross Module References
	...
	void UDamageFormula::GetDamageAmount(UCombatantComponent* Instigator, UCombatantComponent* Target, float& DamageOut)
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Instigator_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Instigator = { "Instigator", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DamageFormula_eventGetDamageAmount_Parms, Instigator), Z_Construct_UClass_UCombatantComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Instigator_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Instigator_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Target_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DamageFormula_eventGetDamageAmount_Parms, Target), Z_Construct_UClass_UCombatantComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Target_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDamageFormula_GetDamageAmount_Statics::NewProp_Target_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDamageFormula_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDamageFormula_GetDamageAmount, "GetDamageAmount" }, // 2349989491
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_DamageFormula_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_DamageFormula_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDamageFormula, UDamageFormula::StaticClass, TEXT("UDamageFormula"), &Z_Registration_Info_UClass_UDamageFormula, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDamageFormula), 3820791368U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_DamageFormula_h_2798096725(TEXT("/Script/OmegaGameFramework"),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_DamageFormula_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_DamageFormula_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
