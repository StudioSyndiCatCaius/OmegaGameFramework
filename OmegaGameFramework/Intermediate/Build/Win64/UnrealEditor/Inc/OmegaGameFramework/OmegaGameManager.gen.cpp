...
// End Cross Module References
	...
	DEFINE_FUNCTION(UOmegaGameManager::execUpdatePlaytime)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdatePlaytime();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UOmegaGameManager::execResetPlaytime)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ResetPlaytime();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UOmegaGameManager::execSetPlaytimeActive)
	{
		P_GET_UBOOL(Z_Param_bActive);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetPlaytimeActive(Z_Param_bActive);
		P_NATIVE_END;
	}
	...
	void UOmegaGameManager::StaticRegisterNativesUOmegaGameManager()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ResetPlaytime", &UOmegaGameManager::execResetPlaytime },
			{ "SetPlaytimeActive", &UOmegaGameManager::execSetPlaytimeActive },
			{ "UpdatePlaytime", &UOmegaGameManager::execUpdatePlaytime },
		};
	...
	struct Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime_Statics::Function_MetaDataParams[] = {
		{ "Category", "Playtime" },
		{ "ModuleRelativePath", "Public/OmegaGameManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOmegaGameManager, nullptr, "ResetPlaytime", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics
	{
		struct OmegaGameManager_eventSetPlaytimeActive_Parms
		{
			bool bActive;
		};
	...
	void Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::NewProp_bActive_SetBit(void* Obj)
	{
		((OmegaGameManager_eventSetPlaytimeActive_Parms*)Obj)->bActive = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::NewProp_bActive = { "bActive", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(OmegaGameManager_eventSetPlaytimeActive_Parms), &Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::NewProp_bActive_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::NewProp_bActive,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::Function_MetaDataParams[] = {
		{ "Category", "Playtime" },
		{ "ModuleRelativePath", "Public/OmegaGameManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOmegaGameManager, nullptr, "SetPlaytimeActive", nullptr, nullptr, sizeof(Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::OmegaGameManager_eventSetPlaytimeActive_Parms), Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/OmegaGameManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOmegaGameManager, nullptr, "UpdatePlaytime", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Playtime_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_Playtime;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bIsPlaytimeActive_MetaData[];
#endif
		static void NewProp_bIsPlaytimeActive_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsPlaytimeActive;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_PlaytimeUpdateHandle_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_PlaytimeUpdateHandle;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOmegaGameManager_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UOmegaGameManager_ResetPlaytime, "ResetPlaytime" }, // 1914734288
		{ &Z_Construct_UFunction_UOmegaGameManager_SetPlaytimeActive, "SetPlaytimeActive" }, // 2221734500
		{ &Z_Construct_UFunction_UOmegaGameManager_UpdatePlaytime, "UpdatePlaytime" }, // 126505046
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_Playtime_MetaData[] = {
		{ "Category", "Playtime" },
		{ "Comment", "// Playtime\n" },
		{ "ModuleRelativePath", "Public/OmegaGameManager.h" },
		{ "ToolTip", "Playtime" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_Playtime = { "Playtime", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOmegaGameManager, Playtime), Z_Construct_UScriptStruct_FTimecode, METADATA_PARAMS(Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_Playtime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_Playtime_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive_MetaData[] = {
		{ "Category", "Playtime" },
		{ "ModuleRelativePath", "Public/OmegaGameManager.h" },
	};
#endif
	void Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive_SetBit(void* Obj)
	{
		((UOmegaGameManager*)Obj)->bIsPlaytimeActive = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive = { "bIsPlaytimeActive", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UOmegaGameManager), &Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_PlaytimeUpdateHandle_MetaData[] = {
		{ "ModuleRelativePath", "Public/OmegaGameManager.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_PlaytimeUpdateHandle = { "PlaytimeUpdateHandle", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOmegaGameManager, PlaytimeUpdateHandle), Z_Construct_UScriptStruct_FTimerHandle, METADATA_PARAMS(Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_PlaytimeUpdateHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_PlaytimeUpdateHandle_MetaData)) }; // 589591453
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOmegaGameManager_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_Playtime,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_bIsPlaytimeActive,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOmegaGameManager_Statics::NewProp_PlaytimeUpdateHandle,
	};
	...
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_OmegaGameManager_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_OmegaGameManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOmegaGameManager, UOmegaGameManager::StaticClass, TEXT("UOmegaGameManager"), &Z_Registration_Info_UClass_UOmegaGameManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOmegaGameManager), 594201213U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_OmegaGameManager_h_1735483952(TEXT("/Script/OmegaGameFramework"),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_OmegaGameManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_OmegaGameManager_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
