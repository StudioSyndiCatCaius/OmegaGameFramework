...
// End Cross Module References
	...
	DEFINE_FUNCTION(UDataAssetCollectionComponent::execGetCollectionMap)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TMap<UPrimaryDataAsset*,int32>*)Z_Param__Result=P_THIS->GetCollectionMap();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UDataAssetCollectionComponent::execSetCollectionMap)
	{
		P_GET_TMAP(UPrimaryDataAsset*,int32,Z_Param_Map);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UDataAssetCollectionComponent::execGetCollectionAsArray)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<UPrimaryDataAsset*>*)Z_Param__Result=P_THIS->GetCollectionAsArray(Z_Param_Asset);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UDataAssetCollectionComponent_GetCollectionAsArray_Statics
	{
		...
		{
			UPrimaryDataAsset* Asset;
			TArray<UPrimaryDataAsset*> ReturnValue;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_Asset;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDataAssetCollectionComponent_GetCollectionAsArray_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPrimaryDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UDataAssetCollectionComponent_GetCollectionMap_Statics
	{
		...
		{
			TMap<UPrimaryDataAsset*,int32> ReturnValue;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDataAssetCollectionComponent_GetCollectionMap_Statics::NewProp_ReturnValue_Key_KeyProp = { "ReturnValue_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPrimaryDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDataAssetCollectionComponent_NativeRemoveAsset_Statics::NewProp_Asset = { "Asset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DataAssetCollectionComponent_eventNativeRemoveAsset_Parms, Asset), Z_Construct_UClass_UPrimaryDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UDataAssetCollectionComponent_SetCollectionMap_Statics
	{
		...
		{
			TMap<UPrimaryDataAsset*,int32> Map;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDataAssetCollectionComponent_SetCollectionMap_Statics::NewProp_Map_Key_KeyProp = { "Map_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPrimaryDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDataAssetCollectionComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_AddAsset, "AddAsset" }, // 671574733
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_GetAssetNumberOfType, "GetAssetNumberOfType" }, // 4119129294
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_GetAssetNumberTotal, "GetAssetNumberTotal" }, // 3283326381
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_GetCollectionAsArray, "GetCollectionAsArray" }, // 305560840
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_GetCollectionMap, "GetCollectionMap" }, // 3552434674
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_NativeAddAsset, "NativeAddAsset" }, // 1994253807
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_NativeRemoveAsset, "NativeRemoveAsset" }, // 3499570525
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_RemoveAsset, "RemoveAsset" }, // 3840872199
		{ &Z_Construct_UFunction_UDataAssetCollectionComponent_SetCollectionMap, "SetCollectionMap" }, // 1246279647
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDataAssetCollectionComponent_Statics::NewProp_CollectionMap_Key_KeyProp = { "CollectionMap_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPrimaryDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Data_DataAssetCollectionComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Data_DataAssetCollectionComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataAssetCollectionComponent, UDataAssetCollectionComponent::StaticClass, TEXT("UDataAssetCollectionComponent"), &Z_Registration_Info_UClass_UDataAssetCollectionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataAssetCollectionComponent), 2116915704U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Data_DataAssetCollectionComponent_h_1962086477(TEXT("/Script/OmegaGameFramework"),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Data_DataAssetCollectionComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Data_DataAssetCollectionComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
