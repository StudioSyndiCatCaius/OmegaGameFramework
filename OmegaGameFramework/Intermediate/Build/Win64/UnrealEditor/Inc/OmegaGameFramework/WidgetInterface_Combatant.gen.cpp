...
// End Cross Module References
	DEFINE_FUNCTION(IWidgetInterface_Combatant::execOnCombatantUpdated)
	{
		P_GET_OBJECT(UCombatantComponent,Z_Param_Combatant);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnCombatantUpdated_Implementation(Z_Param_Combatant);
		P_NATIVE_END;
	}
	...
	void IWidgetInterface_Combatant::OnCombatantUpdated(UCombatantComponent* Combatant)
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_OnCombatantUpdated instead.");
	}
	void UWidgetInterface_Combatant::StaticRegisterNativesUWidgetInterface_Combatant()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnCombatantUpdated", &IWidgetInterface_Combatant::execOnCombatantUpdated },
		};
	...
	struct Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::NewProp_Combatant_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::NewProp_Combatant = { "Combatant", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(WidgetInterface_Combatant_eventOnCombatantUpdated_Parms, Combatant), Z_Construct_UClass_UCombatantComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::NewProp_Combatant_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::NewProp_Combatant_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::NewProp_Combatant,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::Function_MetaDataParams[] = {
		{ "Category", "\xce\xa9|Widget|Combatant" },
		{ "ModuleRelativePath", "Public/Widget/WidgetInterface_Combatant.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWidgetInterface_Combatant, nullptr, "OnCombatantUpdated", nullptr, nullptr, sizeof(WidgetInterface_Combatant_eventOnCombatantUpdated_Parms), Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWidgetInterface_Combatant_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UWidgetInterface_Combatant_OnCombatantUpdated, "OnCombatantUpdated" }, // 1489793022
	};
#if WITH_METADATA
	...
	static FName NAME_UWidgetInterface_Combatant_OnCombatantUpdated = FName(TEXT("OnCombatantUpdated"));
	void IWidgetInterface_Combatant::Execute_OnCombatantUpdated(UObject* O, UCombatantComponent* Combatant)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UWidgetInterface_Combatant::StaticClass()));
		WidgetInterface_Combatant_eventOnCombatantUpdated_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_UWidgetInterface_Combatant_OnCombatantUpdated);
		if (Func)
		{
		...
		{
			I->OnCombatantUpdated_Implementation(Combatant);
		}
	}
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_WidgetInterface_Combatant_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_WidgetInterface_Combatant_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetInterface_Combatant, UWidgetInterface_Combatant::StaticClass, TEXT("UWidgetInterface_Combatant"), &Z_Registration_Info_UClass_UWidgetInterface_Combatant, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetInterface_Combatant), 2711741939U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_WidgetInterface_Combatant_h_1230374009(TEXT("/Script/OmegaGameFramework"),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_WidgetInterface_Combatant_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_WidgetInterface_Combatant_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
