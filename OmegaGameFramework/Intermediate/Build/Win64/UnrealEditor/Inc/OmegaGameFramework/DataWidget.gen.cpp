...
// End Cross Module References
	...
	DEFINE_FUNCTION(UDataWidget::execGetIsEntitySelectable)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->GetIsEntitySelectable();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UDataWidget::execDataWidgetHasTag)
	{
		P_GET_PROPERTY(FNameProperty,Z_Param_Tag);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->DataWidgetHasTag(Z_Param_Tag);
		P_NATIVE_END;
	}
	...
	void UDataWidget::AddedToDataList(UDataList* DataList, int32 Index, const UObject* Asset, FGameplayTagContainer ListTags, const FString& ListFlag)
	{
	...
	void UDataWidget::StaticRegisterNativesUDataWidget()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "DataWidgetHasTag", &UDataWidget::execDataWidgetHasTag },
			{ "GetAssetLabel", &UDataWidget::execGetAssetLabel },
			{ "GetIsEntitySelectable", &UDataWidget::execGetIsEntitySelectable },
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ListFlag_MetaData[];
#endif
		static const UECodeGen_Private::FStrPropertyParams NewProp_ListFlag;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::NewProp_ListTags = { "ListTags", nullptr, (EPropertyFlags)0x0010040000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DataWidget_eventAddedToDataList_Parms, ListTags), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(nullptr, 0) }; // 506667518
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::NewProp_ListFlag_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::NewProp_ListFlag = { "ListFlag", nullptr, (EPropertyFlags)0x0010040000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DataWidget_eventAddedToDataList_Parms, ListFlag), METADATA_PARAMS(Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::NewProp_ListFlag_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::NewProp_ListFlag_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDataWidget_AddedToDataList_Statics::NewProp_ListFlag,
	};
#if WITH_METADATA
	...
	struct Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics
	{
		struct DataWidget_eventDataWidgetHasTag_Parms
		{
			FName Tag;
			bool ReturnValue;
		};
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DataWidget_eventDataWidgetHasTag_Parms, Tag), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((DataWidget_eventDataWidgetHasTag_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DataWidget_eventDataWidgetHasTag_Parms), &Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::NewProp_Tag,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::Function_MetaDataParams[] = {
		{ "Category", "DataWidget" },
		{ "ModuleRelativePath", "Public/Widget/DataWidget.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDataWidget, nullptr, "DataWidgetHasTag", nullptr, nullptr, sizeof(Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::DataWidget_eventDataWidgetHasTag_Parms), Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDataWidget_DataWidgetHasTag()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UDataWidget_DataWidgetHasTag_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics
	{
		struct DataWidget_eventGetIsEntitySelectable_Parms
		{
			bool ReturnValue;
		};
		static void NewProp_ReturnValue_SetBit(void* Obj);
	...
	void Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((DataWidget_eventGetIsEntitySelectable_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DataWidget_eventGetIsEntitySelectable_Parms), &Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::Function_MetaDataParams[] = {
		{ "Category", "\xce\xa9|Widget|DataWidget" },
		{ "ModuleRelativePath", "Public/Widget/DataWidget.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDataWidget, nullptr, "GetIsEntitySelectable", nullptr, nullptr, sizeof(Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::DataWidget_eventGetIsEntitySelectable_Parms), Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDataWidget_IsEntityDisabled_Statics::Function_MetaDataParams[] = {
		{ "Category", "\xce\xa9|Widget|DataWidget" },
		{ "DisplayName", "Is Entity Unselectable" },
		{ "ModuleRelativePath", "Public/Widget/DataWidget.h" },
	};
#endif
	...
	struct Z_Construct_UClass_UDataWidget_Statics
	{
		...
		static void NewProp_bIsHovered_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsHovered;
		static const UECodeGen_Private::FNamePropertyParams NewProp_WidgetTags_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_WidgetTags_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_WidgetTags;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDataWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDataWidget_AddedToDataList, "AddedToDataList" }, // 4086310773
		{ &Z_Construct_UFunction_UDataWidget_DataWidgetHasTag, "DataWidgetHasTag" }, // 2608530842
		...
		{ &Z_Construct_UFunction_UDataWidget_GetIsEntitySelectable, "GetIsEntitySelectable" }, // 2040237923
		...
		{ &Z_Construct_UFunction_UDataWidget_IsEntityDisabled, "IsEntityDisabled" }, // 2695365875
		{ &Z_Construct_UFunction_UDataWidget_IsEntityHidden, "IsEntityHidden" }, // 3009351327
		{ &Z_Construct_UFunction_UDataWidget_OnNewListOwner, "OnNewListOwner" }, // 1982878014
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags_Inner = { "WidgetTags", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags_MetaData[] = {
		{ "Category", "DataWidget" },
		{ "Comment", "//Tags\n" },
		{ "ModuleRelativePath", "Public/Widget/DataWidget.h" },
		{ "ToolTip", "Tags" },
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags = { "WidgetTags", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDataWidget, WidgetTags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDataWidget_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDataWidget_Statics::NewProp_WidgetTags,
	...
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_DataWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_DataWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataWidget, UDataWidget::StaticClass, TEXT("UDataWidget"), &Z_Registration_Info_UClass_UDataWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataWidget), 3514249721U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_DataWidget_h_981651501(TEXT("/Script/OmegaGameFramework"),
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_DataWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_OmegaGameFramework_Public_Widget_DataWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
