...
template<> ACTIONSEDITOR_API UScriptStruct* StaticStruct<FActionProperties>()
{
	...
	struct Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_ActionsEditor_Private_Nodes_ActionReflection_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_ActionsEditor_Private_Nodes_ActionReflection_h_Statics::ScriptStructInfo[] = {
		{ FBaseActionProperty::StaticStruct, Z_Construct_UScriptStruct_FBaseActionProperty_Statics::NewStructOps, TEXT("BaseActionProperty"), &Z_Registration_Info_UScriptStruct_BaseActionProperty, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBaseActionProperty), 4085049850U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_ActionsEditor_Private_Nodes_ActionReflection_h_1921342073(TEXT("/Script/ActionsEditor"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_ActionsEditor_Private_Nodes_ActionReflection_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Rebuild5_Plugins_OmegaGameFramework_Source_ActionsEditor_Private_Nodes_ActionReflection_h_Statics::ScriptStructInfo),
		nullptr, 0);
