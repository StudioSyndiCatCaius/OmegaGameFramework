...
UCLASS(DisplayName="Ω TRIGGER - Flow")
class OMEGADEMO_API AOmegaTrigger_Flow : public AAdvancedVolume
{
	GENERATED_BODY()
public:
	AOmegaTrigger_Flow();
	
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="EventVolume") UFlowAsset* FlowAsset;
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="EventVolume") FString Flag;
	//UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="EventVolume") FString Flag;
...
UCLASS(DisplayName="Ω TRIGGER - Scripted Event")
