...
UCLASS()
class OMEGAGAMEFRAMEWORK_API UOmegaFunctions_MIDI : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
...
public:
    ...
    static bool ParseMidiFile(const FString& FilePath, FOmegaMidi_Data& OutMidiData);
};
