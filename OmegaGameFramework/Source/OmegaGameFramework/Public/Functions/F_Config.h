...
public:
	...
	UFUNCTION(BlueprintPure, Category="Omega|Config", DisplayName="⚙️ ini Config - Get (Bool)")
	static bool GetBool(const FString& Section, const FString& Param);

	UFUNCTION(BlueprintPure, Category="Omega|Config", DisplayName="⚙️ ini Config - Get (Float)")
	static float GetFloat(const FString& Section, const FString& Param);

	UFUNCTION(BlueprintPure, Category="Omega|Config", DisplayName="⚙️ ini Config - Get (Int32)")
	static int32 GetInt(const FString& Section, const FString& Param);

	UFUNCTION(BlueprintPure, Category="Omega|Config", DisplayName="⚙️ ini Config - Get (String)")
	static FString GetString(const FString& Section, const FString& Param);

	UFUNCTION(BlueprintPure, Category="Omega|Config", DisplayName="⚙️ ini Config - Get (Vector)")
	static FVector GetVector(const FString& Section, const FString& Param);
	
	UFUNCTION(BlueprintPure, Category="Omega|Config", DisplayName="⚙️ ini Config - Get (Vector2D)")
	static FVector2D GetVector2D(const FString& Section, const FString& Param);
	
	UFUNCTION(BlueprintCallable, Category="Omega|Config", DisplayName="⚙️ ini Config - Set (Bool)")
	static void SetBool(const FString& Section, const FString& Param, bool Value);

	UFUNCTION(BlueprintCallable, Category="Omega|Config", DisplayName="⚙️ ini Config - Set (Float)")
	static void SetFloat(const FString& Section, const FString& Param, float Value);

	UFUNCTION(BlueprintCallable, Category="Omega|Config", DisplayName="⚙️ ini Config - Set (Int32)")
	static void SetInt(const FString& Section, const FString& Param, int32 Value);

	UFUNCTION(BlueprintCallable, Category="Omega|Config", DisplayName="⚙️ ini Config - Set (String)")
	static void SetString(const FString& Section, const FString& Param, const FString& Value);

	UFUNCTION(BlueprintCallable, Category="Omega|Config", DisplayName="⚙️ ini Config - Set (Vector)")
	static void SetVector(const FString& Section, const FString& Param, FVector Value);

	UFUNCTION(BlueprintCallable, Category="Omega|Config", DisplayName="⚙️ ini Config - Set (Vector2D)")
