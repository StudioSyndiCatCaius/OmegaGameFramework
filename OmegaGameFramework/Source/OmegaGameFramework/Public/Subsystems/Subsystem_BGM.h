...
#include "Subsystem_BGM.generated.h"
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="General", meta=(MultiLine), DisplayName="Description")
	...
	UPROPERTY(EditAnywhere, Instanced, BlueprintReadOnly, Category="General",meta=(ExposeOnSpawn))
