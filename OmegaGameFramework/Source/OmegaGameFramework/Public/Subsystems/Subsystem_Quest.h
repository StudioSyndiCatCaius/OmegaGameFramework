...
#include "Subsystem_Quest.generated.h"
...
public:
	...
	UFUNCTION(BlueprintCallable,Category="OmegaQuestSubsystem",meta=(DeterminesOutputType="Class"))
	TArray<UObject*> GetActiveQuestTasks(TSubclassOf<UObject> Class);
};
