...
#include "I_SoftCondition.generated.h"
...
public:
	...
	static bool CheckObjectSoftCondition(UObject* Object, FName Condition, FOmegaCommonMeta meta, FText& Reason);
	
	UFUNCTION(BlueprintCallable,Category="Omega|SoftCondition",meta=(DeterminesOutputType="ObjectClass"))
	static TArray<UObject*> FilterObjectsBySoftCondition(TArray<UObject*> In, FName Condition, FOmegaCommonMeta meta, bool Invert, TSubclassOf<UObject> ObjectClass);
...
inline TArray<UObject*> UOmegaSoftConditionFunctions::FilterObjectsBySoftCondition(TArray<UObject*> In, FName Condition,
	FOmegaCommonMeta meta, bool Invert, TSubclassOf<UObject> ObjectClass)
{
	TArray<UObject*> out;
	for(auto* o :In)
	{
		if (o && (!ObjectClass || o->GetClass()->IsChildOf(ObjectClass)))
		{
			FText dum;
			if(CheckObjectSoftCondition(o,Condition,meta,dum)!=Invert)
			{
				out.Add(o);
			}
		}
