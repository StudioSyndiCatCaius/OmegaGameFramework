...
#include "DA_CombatantGambits.generated.h"
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category="Combat|Gambit")
	bool CanRunGambit(const UCombatantComponent* Combatant) const;
...
public:
	...
	UFUNCTION()
	TArray<UCombatantGambitAction*> GetAllGambitActions();
	...
	UPROPERTY(BlueprintReadOnly,Instanced,EditAnywhere, Category="Gambits")
	TArray<UCombatantGambitAction*> GambitActions;
