...
int32 UOmegaFunctions_MIDI::ReadVariableLength(const TArray<uint8>& Data, int32& Position)
{
    int32 Value = 0;
    uint8 Byte;
    do
...
void UOmegaFunctions_MIDI::HandleNoteOff(FOmegaMidi_Track& Track, TMap<uint8, FOmegaMidi_Key>& ActiveNotes, uint8 Note,
    float CurrentTime)
{
...
bool UOmegaFunctions_MIDI::ParseMidiFile(const FString& FilePath, FOmegaMidi_Data& OutMidiData)
{
