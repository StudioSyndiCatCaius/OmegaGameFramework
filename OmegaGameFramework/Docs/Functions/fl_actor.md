...
Covers: `F_Actor`, `F_Component`, `F_Physics`, `F_Trace`, `F_ActorWeb`
...
## Actor Web (`UOmegaFunctions_ActorWeb`)

Visualizes connections between actors.

| Node | Description |
|---|---|
| **Create Cache** | Create a web cache from an array of actors. |
| **Get Lines** | Extract connection line data from a web cache for rendering. |
