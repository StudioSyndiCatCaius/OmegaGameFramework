...
## IDataAssetCollectionInterface

Implement this on an item data asset to define its collection rules.

| Method | Description |
|---|---|
| **Get Max Collection Number** | Returns the maximum number of this item that can be held at once. |
| **Get Size Per Amount** | Returns how much "space" each unit of this item takes. |
| **Get Trade Asset Requirements** | Returns what assets are required to trade for this item. Pass a **Trade Tag** to support multiple trade types. |
