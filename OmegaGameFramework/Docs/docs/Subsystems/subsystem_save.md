...
## Save-Based Actor Visibility

The **Gameplay Actor Component** (`UGameplayActorComponent`) can automatically show or hide its actor based on save tags — no Blueprint event binding required. See its **👁️Visibility** category:
