...
> To narrow a combatant list (allies only, enemies in range, etc.), use **Combatant Filter Script** Blueprints and **Combatant Filter Collection** assets with the Combatant Filter function library nodes.
