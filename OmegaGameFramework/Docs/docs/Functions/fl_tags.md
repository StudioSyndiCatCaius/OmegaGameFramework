...
Covers: `F_TagEvent`, `F_GlobalParam`, `F_SoftProperty`, `F_SoftCondition`, `F_IntState`, `F_BitFlag`, `F_Machina`
...
A simple integer state interface — any object implementing `DataInterface_IntState` can have a tracked integer state.
